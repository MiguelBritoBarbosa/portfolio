...
export default async function Autores({ autores }: AuthorsProps) {
    ...
    return (
        <Container>
            <Heading className="text-center my-2" size={{ initial: '6', md: '7', lg: '8' }}>
                {t('Authors')}
            </Heading>
            <section className="container mx-auto py-8 grid md:grid-cols-2 lg:grid-cols-3 px-2 sm:px-4 gap-4 rounded bg-gray-300 dark:bg-gray-900">
                {autores.map((autor) => {
